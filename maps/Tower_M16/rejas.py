...
Sparks.SetMetalSparkling("candelab3")
Sparks.SetMetalSparkling("candelab8")
Sparks.SetMetalSparkling("candelab4")
...
Sparks.SetWoodenSparkling("meson1")
Sparks.SetWoodenSparkling("taburete1")
Sparks.SetWoodenSparkling("taburete2")
Sparks.SetWoodenSparkling("taburete3")
