...
CriptaSuenaSec = Bladex.GetSector(36708.0332859, 6898.23509095, 19675.5824)
CriptaSuenaSec.OnEnter = CriptaSuena

####Sector que los desactiva:
secCriptaNoSuenaLaPutaAlanisMorrisete = Bladex.GetSector(38250,5000,9250)
secCriptaNoSuenaLaPutaAlanisMorrisete.OnEnter = CriptaNoSuenaLaPutaAlanisMorrisete
