...
granpiedradeslizando3=Sounds.CreateEntitySound("../../Sounds/Huge-stone-door.wav", "Granpiedradeslizando2")
granpiedradeslizando3.MaxDistance=50000
granpiedradeslizando3.MinDistance=13000
granpiedradeslizando3.Volume=1.0

cierrepiedra3=Sounds.CreateEntitySound("../../Sounds/Stone-door-shut.wav", "Cierrepiedra2")
cierrepiedra3.MaxDistance=50000
cierrepiedra3.MinDistance=13000
cierrepiedra3.Volume=1.0

granpiedradeslizando4=Sounds.CreateEntitySound("../../Sounds/Huge-stone-door.wav", "Granpiedradeslizando2")
granpiedradeslizando4.MaxDistance=50000
granpiedradeslizando4.MinDistance=13000
granpiedradeslizando4.Volume=1.0

cierrepiedra4=Sounds.CreateEntitySound("../../Sounds/Stone-door-shut.wav", "Cierrepiedra2")
