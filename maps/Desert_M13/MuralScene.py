...
if char.Kind[0]=="A":
	soundhit2player=Sounds.CreateEntitySound('../../Sounds/esfuerzo-caida-amz.wav', 'SoundHit2Player')
	soundhit2player.Volume=0.5
	soundhit2player.MinDistance=100000
	soundhit2player.MaxDistance=200000
	
	soundesfuerzoplayer=Sounds.CreateEntitySound('../../Sounds/esfuerzo-subirAmz3.wav', 'SoundEsfuerzoPlayer')
