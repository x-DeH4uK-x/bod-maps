...
Bladex.AddInputAction("GoToPosFinal", 0)
...
Bladex.AssocKey("GoToPosFinal", "Keyboard", "F", ON_PRESS)
...
Bladex.AddBoundFunc("GoToPosFinal", posicionfinal)
