...
o=Bladex.CreateEntity("WeaponInvPrb2","Naginata",0,0,0,"Weapon")
Actions.TakeObject(char.Name,o.Name)
ItemTypes.ItemDefaultFuncs (o)
inv.AddWeapon(o.Name)
...
o=Bladex.CreateEntity("WeaponInvPrb2","Guadanya",0,0,0,"Weapon")
Actions.TakeObject(char.Name,o.Name)
ItemTypes.ItemDefaultFuncs (o)
inv.AddWeapon(o.Name)
...
o=Bladex.CreateEntity("WeaponInvPrb2","Hacha3",0,0,0,"Weapon")
Actions.TakeObject(char.Name,o.Name)
ItemTypes.ItemDefaultFuncs (o)
inv.AddWeapon(o.Name)
