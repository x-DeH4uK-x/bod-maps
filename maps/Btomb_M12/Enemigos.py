...
# orco a la izquierda del personaje seg�n entra.
...
# orco a la derecha del personaje seg�n entra
...
# orco mayor con poci�n frente a gran rastrillo mirando a la izquierda
