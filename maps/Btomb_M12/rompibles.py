...
pocima=Breakings.CreateHiddenObject("BtombPocimaCofre", "PocimaTodo",1.2,(0.0,0.0,0.0),(0.5,0.5,0.5,-0.5))
pocima.Solid=1
pocima.Static=0
pocimac.CreatePotion("BtombPocimaCofre")
...
Breakings.SetBreakable("NoName35",12,100,"BtombPocimaCofre")
